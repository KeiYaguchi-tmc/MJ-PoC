let icon_tool = '<circle cx="12" cy="12" r="9" fill="none" fill-rule="evenodd" stroke="currentColor" stroke-width="2"></circle>'
let icon_monojo =
  ...
  miro.initialize({
    extensionPoints: {
      bottomBar: {
        ...
        positionPriority: 1,
        onClick: () => {
          miro.board.ui.openLeftSidebar('sidebar.html', {title: 'ツールボックス'})
        },
      },
      toolbar: {
        title: '物と情報の流れ図',
        librarySvgIcon: icon_monojo,
        toolbarSvgIcon: icon_monojo,
        onClick: () => {
